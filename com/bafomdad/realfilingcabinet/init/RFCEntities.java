...
public class RFCEntities {
	...
	public static void init() {
		...
		EntityRegistry.registerModEntity(ResourceUpgradeHelper.getMobDefault(), EntityCabinet.class, "cabinet", 0, RealFilingCabinet.instance, 64, 3, true, 0xFFFFFF, 0xEBE1DF);
	}
