...
public class FolderAspectRecipe extends ShapelessRecipes implements IRecipe {
	
	public static List inputs = new ArrayList();
	
	static {
		inputs.add(new ItemStack(RFCItems.aspectFolder));
	}

	public FolderAspectRecipe() {
		
		super(new ItemStack(RFCItems.aspectFolder), inputs);
	}
