...
public class RFCRecipes {
    ...
    public static RecipeSerializers.Dummy<FolderTapeRecipe> FOLDER_TAPE_RECIPE;
    ...
    public static void init() {
        ...
        registerSerializer(FOLDER_TAPE_RECIPE, "crafting_special_foldertape", new FolderTapeRecipe("foldertape"));
    }
